...
const PortraitCard = ({ cert }) => {
  ...
  return (
    ...
    >
      ...
      >
        {/* FRONT */}
        <div className="absolute inset-0 rounded-[20px] border border-violet-500/25 flex flex-col items-center justify-end pb-8 overflow-hidden text-center backface-hidden transition-all duration-300 group-hover:bg-black/40">
        ...
        {/* BACK */}
        <div className="absolute inset-0 rounded-[20px] border border-violet-500/40 p-6 flex flex-col items-center justify-center gap-2.5 text-center backface-hidden rotate-y-180 bg-linear-to-b from-[#1a0033] via-[#2d0066] to-[#1a0033]">
          <div className="text-4xl mb-1">{cert.icon}</div>
          <h4 className="m-0 text-[15px] font-bold text-white leading-snug">
            {cert.title}
          </h4>
